...
namespace ZenkraftService
{
    public class ZkService
    {
        ...
        public bool Pickup(Pickup pickup, List<Int64> shipments, string paymentMethod, bool overweight)
        {
            ...
            try
            {
                ...
                dataObj["shipments"] = JArray.FromObject(shipments);
                dataObj["payment_method"] = paymentMethod;
                dataObj["overweight"] = overweight;
                dataObj["test"] = Test;
